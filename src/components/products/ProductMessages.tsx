...
const ProductMessages: React.FC<ProductMessagesProps> = ({
  productId,
  marketerId = "m2",
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      senderId: marketerId,
      senderName: marketerName,
      content: "هل يتوفر هذا المنتج باللون الأزرق؟",
    ...
    },
    {
      ...
      content: "نعم، المنتج متوفر باللون الأزرق. سيتم إضافته للمخزون خلال أسبوع.",
    ...
    },
    {
      ...
      senderId: marketerId,
      senderName: marketerName,
      content: "هل يمكن توفير خصم للعميل إذا اشترى أكثر من جهاز؟",
    ...
    },
    {
      ...
      senderId: marketerId,
      senderName: marketerName,
      content: "العميل يريد شراء 3 أجهزة، هل يمكن توفير خصم 10%؟",
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      // Simulate sending notification to marketer
    ...
    <Card className="border-2 mt-6">
      <CardHeader className="pb-3 bg-gray-50 rounded-t-lg">
        <CardTitle className="text-xl flex items-center">
          ...
          <span className="font-cairo">رسائل المسوقين</span>
        </CardTitle>
      </CardHeader>
